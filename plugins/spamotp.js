// ================================================================
// 📱 OTP SPAM PLUGIN (For SHAVIYA-XMD Bot Base)
// Credit: t.me/yat1mlau · t.me/abourvin7x · t.me/vinzxcmmnty
// ================================================================
...
cmd({
    pattern: "spamotp",
    desc: "Spam OTP to target number (WhatsApp, SMS, and email services)",
    category: "tools",
    filename: __filename
},
async (conn, mek, m, { from, reply, args }) => {
    ...
    // If there is a quoted message, get its text
    ...
    await reply(`🚀 *Starting OTP spam to number:* ${targetInput}\n_Please wait, this process may take a few minutes._`);
    ...
    try {
        ...
        console.error("OTP Spam Critical Error:", err);
        await conn.sendMessage(from, { react: { text: '❌', key: m.key } });
        reply(`❌ Error: ${err.message || err}`);
    }
});

console.log('✅ OTP Spam Plugin Loaded!');
console.log('📌 Command: .spamotp');
console.log('📌 Usage: .spamotp <phone_number>');
