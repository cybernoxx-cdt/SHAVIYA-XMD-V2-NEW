...
const DEFAULTS = {
    ...
    autoReadStatus: envBool('AUTO_READ_STATUS', true),
    autoStatusRead: envBool('AUTO_READ_STATUS', true),   // alias used by index.js + autostatus plugin
    autoStatusLike: envBool('AUTO_REACT_STATUS', false), // used by index.js + autostatus plugin
